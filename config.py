...
# ---------------------------------------------------------------------------
# Film Production — Proveedores PREMIUM (🔒 Admin-only)
# ---------------------------------------------------------------------------
COMFYUI_CLOUD_API_KEY: str = os.environ.get("COMFYUI_CLOUD_API_KEY", "")
COMFYUI_SHARED_WORKFLOW: str = os.environ.get("COMFYUI_SHARED_WORKFLOW", "773d308ebcf0")
HIGGSFIELD_TOKEN: str = os.environ.get("HIGGSFIELD_TOKEN", "")
