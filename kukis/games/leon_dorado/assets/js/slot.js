...
// Failsafe: si el loader se cuelga (asset faltante, red lenta), no dejar
// al jugador congelado para siempre en la pantalla de "Cargando".
setTimeout(()=>{
  if(loadEl && loadEl.style.display!=='none'){
    console.warn('Timeout cargando assets');
    loadEl.innerHTML = '<div style="color:#fc6;font-family:monospace;text-align:center;padding:20px">Esto esta tardando mas de lo normal.<br>Verifica tu conexion o recarga la pagina.</div>';
  }
}, 15000);
