...
import { 
  ArrowLeft, Heart, Share2, Award, Calendar, 
  Layers, Users, ShieldAlert, Sparkles, MessageSquare,
  Send, Coins, Gem, Gift, Check, Mic
} from 'lucide-react';
...
export default function ArtistProfilePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    const artistId = params.id || 'leo_vela_uid';
