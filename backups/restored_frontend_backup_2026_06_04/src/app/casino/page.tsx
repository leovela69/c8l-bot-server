...
type GameTab = "roulette" | "solitaire" | "derby" | "f1" | "quantumSlot" | "sirenasSlot" | "ziriaSlot";
  ...
  return (
    <div className="min-h-screen text-white relative font-sans pt-32 pb-24 overflow-hidden bg-gradient-to-br from-[#0c0507] via-[#050505] to-[#120409]">
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <div className="bg-black/20 border border-white/5 rounded-3xl p-8 min-h-[500px] flex items-center justify-center relative overflow-hidden box-glow-neon">
